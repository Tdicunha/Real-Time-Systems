...
#define T2 200
#define T3 300
#define NSECTSEC 1000000000 //nanosegundos em segundo1
double maxt1=0;  
double maxt2=0;
double maxt3=0;
double mint1=10000;  
...
int main(int argc,char *argv[]){
	...
	pthread_attr_setschedpolicy(&atribute,SCHED_RR); //RR
	parameter.sched_priority=sched_get_priority_max(SCHED_RR);  //coloca a prioridade a maximo (
